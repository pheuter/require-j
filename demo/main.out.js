...
define("jade", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.window.jade;
    };
}(this)));
...
define("runtime", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.jade;
    };
}(this)));

define('j',{load: function(id){throw new Error("Dynamic load not allowed: " + id);}});
define('j!templates/template',[],function() {
...
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 4, filename: __jade[0].filename });
buf.push('You should see this instead of \'Layout text\'');
__jade.shift();
__jade.shift();
buf.push('</p>');
__jade.shift();
...
define('j!templates/layout_copy',[],function() {
  return function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var __jade = [{ lineno: 1, filename: undefined }];
try {
